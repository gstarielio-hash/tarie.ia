...
export const SIDE_PANEL_WIDTH = Math.min(
  372,
  Math.max(304, SCREEN_WIDTH * 0.82),
);
...
export const HELP_CENTER_ARTICLES = [
  {
    ...
    category: "Operação",
    summary:
      "Como abrir um registro limpo, conversar com a Tariel.ia e ganhar velocidade em campo.",
    body: "Comece descrevendo o local, o achado principal e o impacto observado. A Tariel.ia transforma isso em um registro técnico claro, sugere próximos passos e organiza o contexto do laudo para você continuar sem sobrecarregar a tela.",
    estimatedRead: "2 min",
  },
  {
...
export const UPDATE_CHANGELOG = [
  {
    ...
    summary:
      "Launcher, login e estados vazios agora usam a identidade TG com acentos mais sutis.",
  },
  {
    id: "update-2",
