...
export const SPEECH_LANGUAGE_OPTIONS = ["Sistema", "Português", "Inglês", "Espanhol"] as const;
...
export const MEDIA_COMPRESSION_OPTIONS = ["forte", "equilibrada", "leve", "original"] as const;
